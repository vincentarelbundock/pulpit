...
use crate::vendor::iced_aw::glyphs::{cancel, ok};
use iced_core::{
...
/// The overlay of the [`ColorPicker`](crate::vendor::iced_aw::widget::ColorPicker).
    ...
    fn on_event_keyboard(&mut self, event: &Event, shell: &mut Shell<Message>) -> event::Status {
        ...
        if let Event::Keyboard(keyboard::Event::KeyPressed { key, .. }) = event {
            ...
            if matches!(key, keyboard::Key::Named(keyboard::key::Named::Tab)) {
                ...
                //
                // VENDOR: upstream writes this as a let-chain, which is Rust
                // 2024 syntax; this crate is on the 2021 edition.

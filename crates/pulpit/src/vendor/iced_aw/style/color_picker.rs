...
/// The appearance of a [`ColorPicker`](crate::vendor::iced_aw::widget::ColorPicker).
#[derive(Clone, Copy, Debug)]
pub struct Style {
    /// The background of the [`ColorPicker`](crate::vendor::iced_aw::widget::ColorPicker).
    pub background: Background,

    /// The border radius of the [`ColorPicker`](crate::vendor::iced_aw::widget::ColorPicker).
    pub border_radius: f32,

    /// The border with of the [`ColorPicker`](crate::vendor::iced_aw::widget::ColorPicker).
    pub border_width: f32,

    /// The border color of the [`ColorPicker`](crate::vendor::iced_aw::widget::ColorPicker).
    pub border_color: Color,

    /// The border radius of the bars of the [`ColorPicker`](crate::vendor::iced_aw::widget::ColorPicker).
    pub bar_border_radius: f32,

    /// The border width of the bars of the [`ColorPicker`](crate::vendor::iced_aw::widget::ColorPicker).
    pub bar_border_width: f32,

    /// The border color of the bars of the [`ColorPicker`](crate::vendor::iced_aw::widget::ColorPicker).
    pub bar_border_color: Color,
}

/// The Catalog of a [`ColorPicker`](crate::vendor::iced_aw::widget::ColorPicker).
pub trait Catalog {
...
/// The primary theme of a [`Badge`](crate::vendor::iced_aw::widget::badge::Badge).
#[must_use]

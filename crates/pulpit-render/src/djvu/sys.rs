...
/// the executable is searched, unlike the PDFium binding — a copy found there
/// would be a bundled one, and §65.1 forbids bundling a Class B library.
...
/// Silence the unused-import warning on a build where nothing else needs it.
